...
import {
  get,
  getModelSchemaRef, patch, post, put, requestBody,
  response
} from '@loopback/rest';
import {University} from '../models';
import {UniversityRepository} from '../repositories';
import {getFacultiesRequestBody, getMajorsRequestBody, getTemplatesRequestBody, NewFacultyRequestBody, NewMajorRequestBody, NewTemplateRequestBody, newUniversityRequestBody, searchUniversityRequestBody} from '../requestSchemas/university';
...
export class UniversitiesController {
  ...
  async searchUnis(
    @requestBody(searchUniversityRequestBody) search: {'searchParam': string}
