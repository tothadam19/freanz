...
RefreshtokenService = (0, tslib_1.__decorate)([
    (0, core_1.injectable)({ scope: core_1.BindingScope.TRANSIENT }),
    (0, tslib_1.__param)(0, (0, core_1.inject)(keys_1.RefreshTokenServiceBindings.REFRESH_SECRET)),
    (0, tslib_1.__param)(1, (0, core_1.inject)(keys_1.RefreshTokenServiceBindings.REFRESH_EXPIRES_IN)),
    (0, tslib_1.__param)(2, (0, core_1.inject)(keys_1.RefreshTokenServiceBindings.REFRESH_ISSUER)),
    (0, tslib_1.__param)(3, (0, repository_1.repository)(repositories_1.RefreshTokenRepository)),
    (0, tslib_1.__param)(4, (0, core_1.inject)(keys_1.UserServiceBindings.USER_SERVICE)),
    (0, tslib_1.__param)(5, (0, core_1.inject)(keys_1.TokenServiceBindings.TOKEN_SERVICE)),
    (0, tslib_1.__metadata)("design:paramtypes", [String, String, String, repositories_1.RefreshTokenRepository,
